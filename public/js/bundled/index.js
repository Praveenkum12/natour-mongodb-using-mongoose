...
},{"./logIn":"ALWe3","./logout":"1ftRF","./updateSettings":"l3cGY","./stripe":"10tSC","./signup":"fNY2o","@babel/polyfill":"dTCHC"}],"ALWe3":[function(require,module,exports) {
...
const login = async function(email, password) {
    try {
        ...
        if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Logged in succcessfully!!");
...
const logout = async function() {
    try {
        await (0, _axiosDefault.default)("/api/v1/users/logout");
        // this helps to reload the server
        location.reload(true);
        location.assign("/");
    } catch (err) {
        (0, _alert.showAlert)("error", "Error on Logging out. Try again!");
    }
};
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const updateSetting = async function(data, type) {
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5","./alert":"kxdiQ"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
},{}]},["dafvh","f2QDv"], "f2QDv", "parcelRequire1248")
